module.exports = async function (context, req) {
    ...
    response = {"results": [
        { "time": "13:00-13:40", "id": "Keynote", "session_name": "Develop our future vision", "company": "Microsoft", "name": "井上 章 / 小田 祥平 / 横井 羽衣子", "description": "キーノートセッションです", "": "" },
        ...
        { "time": "16:45-17:25", "id": "BS10", "session_name": "Microsoft と GitHub の開発エコシステムで、開発にドライブをかけよう！", "company": "Microsoft", "name": "服部 佑樹", "description": "本セッションではアプリケーション開発者の皆様が、Microsoft と GitHub のエコシステムを使っ て開発を効率化する方法についてお伝えします。 クラウドが始まってから 10 年あまり、IaaS や PaaS の技術は進化を遂げ、サービスの開発はとて も楽になりました。 今までインフラとアプリは近いようで離れた存在でしたが、クラウドの進化で確実にその距離が近 づいています。 このことはアプリケーションエンジニアが、さらに多くのことを実現できることを意味します。 CI/CD パイプラインを提供する GitHub Actions や、フロントエンドアプリをホスティングする Azure Static Web Apps、軽量な Serverless 実行環境を提供する Azure Functions など、 拡がるアプリケーション開発の世界とクラウドの連携をぜひご体験ください。", "": "" }
    ]}
    context.res = {
